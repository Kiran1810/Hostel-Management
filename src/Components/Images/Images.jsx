                ...
                <DialogBody>
                    <div className="flex flex-row justify-normal  ">
                        <div className=" mr-8">
                            ...
                            <div className="svg-container  mb-4">
                                <Typography as="a" href={facebook}>
                                    ...
                                    >
                                        <path
                                            d="M38.7627 19.9442C38.7627 9.28286 30.1732 0.640625 19.5791 0.640625C8.9801 0.643023 0.390625 9.28286 0.390625 19.9466C0.390625 29.5792 7.40704 37.5643 16.5768 39.0127V25.5242H11.709V19.9466H16.5816V15.6902C16.5816 10.8535 19.4472 8.1822 23.8282 8.1822C25.9289 8.1822 28.123 8.55867 28.123 8.55867V13.3066H25.7034C23.3223 13.3066 22.5789 14.7958 22.5789 16.3233V19.9442H27.8976L27.0487 25.5218H22.5765V39.0103C31.7463 37.5619 38.7627 29.5768 38.7627 19.9442Z"
                                            fill="white"
                                        />
                                    </svg>
                                </Typography>
                        ...
                        <div className="flex flex-col items-center justify-center ">
                            ...
                            <div className="text-white pt-8  font-Play text-3xl lg:text-5xl">
                                {name}
                            </div>
                            <div className="text-white pt-8 font-K2D lg:text-3xl">
                                Lorem ipsum, dolor sit amet consectetur
                                adipisicing elit. Doloribus necessitatibus
                                consectetur architecto accusantium quae officiis
                                quos ipsam cumque modi dignissimos,
                                reprehenderit perspiciatis alias aspernatur, quo
                                doloremque, pariatur sunt. Eaque, optio nihil.
                                Voluptatibus quasi itaque explicabo totam,
                                voluptas facere. Quia minus minima maxime magni
                                accusamus hic eos perferendis tenetur rem
                                distinctio.
                            </div>
                        </div>
                    </div>
