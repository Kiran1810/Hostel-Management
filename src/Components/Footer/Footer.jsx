...
const LINKS = [
  {
    title: "INITIATIVES",
    items: ["E-SUMMIT", "CRESCENDO", "HELL TO DUST", "ENDFELL"],
  },
  {
    title: "LINKS",
    items: ["HOME", "ABOUT US", "FAQS", "CONTACT US"],
  },
  {
    title: "CONTACT",
    items: ["📍 STUDENT ACTIVITY CENTER, NIT", "HIMACHAL PRADESH 177005", "📧 CONTACT@ECELL.IN"],
  },
];
    ...
    <footer className="relative w-full text-gray-400">
      <div className="mx-auto w-full px-8 border-t-2 border-blue-gray-50 pt-4">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">ECELL NIT HAMIRPUR</a>. All
            Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            <Typography as="a" href="https://www.facebook.com/eclubnith/" className="opacity-80 transition-opacity hover:opacity-100">
            ...
            <Typography as="a" href="https://www.instagram.com/ecell_nith/" className="opacity-80 transition-opacity hover:opacity-100">
              <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fill-rule="evenodd"
