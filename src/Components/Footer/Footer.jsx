...
const LINKS = [
    {
        title: "INITIATIVES",
        items: ["E-CELL", "CRESCENDO"],
        slug: ["https://ecell.nith.ac.in/", "https://e-crescendo.netlify.app/"],
    },
    {
        title: "LINKS",
        items: ["HOME", "LOGIN", "PROFILE"],
        slug: ["/", "/Login", "/app"],
    },
    {
        title: "CONTACT",
            ...
            <div className="mx-auto w-full lg:px-8 px-2 border-t-2 border-blue-gray-50 pt-4">
                <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
                    ...
                    >
                        <img
                            src={Logo}
                            alt="ESummit @ NITH"
                            className="  lg:h-40  p-3    lg:w-48  w-52 h-32 border-white border-r-2"
                        />
                ...
                <div className="mt-12 flex w-full flex-col items-center justify-center py-4 md:flex-row md:justify-between">
                    ...
                    <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
                        <Typography
                            as="a"
                            href="https://www.facebook.com/eclubnith/"
