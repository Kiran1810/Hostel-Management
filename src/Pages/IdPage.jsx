...
function IdCard() {
    ...
    useEffect(() => {
        ...
        try {
            axios
                .get(
                    `https://e-cell-backend2k24-tppt.onrender.com/esummit/user/${user.id}/`,
                    { headers }
                )
                .then((response) =>
                    setUserDetail({
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div className="cardName flex justify-center">
                        {userDetail.name}
                    </div>
                    <div className="lg:w-[332px] lg:h-[283px] w-[266px] h-[266px] small flex flex-col items-center  mt-4">
                        <div className="volunteer lg:text-3xl text-base font-extrabold">
                            VOLUNTEER
                        </div>
                        <div className="items-start lg:mt-4 mt-0 ">
                            <div className="text-sm font-k2d text-[#0A093F] pt-2">
                                Email:
            ...
            <div
                className=" h-screen hidden md:block w-1/2"
                style={flagStyle}
            ></div>
        </>
    );
