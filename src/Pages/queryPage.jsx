...
export function QueryContactPage() {
    ...
    return (
        <div className="flex justify-center  items-center  lg:p-8 ">
            <Card color="transparent" className="w-[100vw]" shadow={false}>
                <Typography
                    variant="h4"
                    color="white"
                    className="text-center text-2xl lg:text-5xl font-Play "
                >
                    CONTACT US
                </Typography>
                <div className="ml-6 mr-6  ">
                    <form className="mt-8 mb-2  lg:w-98">
                        <div className="mb-6 flex flex-col gap-8">
                            ...
                            <div className="flex lg:flex-row flex-col gap-[0.2] lg:gap-0.5">
                                <div className="flex flex-col relative">
                                    <label
                                        htmlFor="phone"
                                        className="text-sm font-medium text-white dark:text-gray-300 absolute top-2 left-2 transition-all pointer-events-none"
                        ...
                        <Button className="bg-blue-600 text-xl lg:text-xl lg:px-6 lg:py-2 ">
                            submit
                        </Button>
                    </form>
                </div>
